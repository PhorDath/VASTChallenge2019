function lineGraph(file){
    ...
    var color = d3.scale.ordinal().range(["#cc0000",  "#0000ff",  "#ff6600", "#72C39B", "#cc0099", "#80CCB3", "#009933"])//, "#7FC7C6", "#7EC4CF", "#7FBBCF", "#7FB1CF", "#80A8CE", "#809ECE", "#8897CE", "#8F90CD", "#9788CD", "#9E81CC", "#AA81C5", "#B681BE", "#C280B7", "#CE80B0", "#D3779F", "#D76D8F", "#DC647E", "#E05A6D", "#E16167", "#E26962", "#E2705C", "#E37756", "#E38457", "#E39158", "#E29D58", "#E2AA59", "#E0B15B", "#DFB95C", "#DDC05E", "#DBC75F", "#E3CF6D", "#EAD67C", "#F2DE8A"]);  
    ...
    var context = svg.append("g") // Brushing context box container
        .attr("transform", "translate(" + 0 + "," + 410 + ")") //410
        .attr("class", "context");
    ...
    d3.csv("data/MC1/" + file, function(error, data) { 
		...
		data.forEach(function(d) { // Make every date in the csv data a javascript date object format
      	...
      	var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
												return {
													...
													visible: (name === "" ? false : true) // "visible": all false except for economy which is true.
												};
											  }
											);
